...
# 12 "initializeHardware.c" 2

# 1 "./initializeHardware.h" 1
# 14 "./initializeHardware.h"
void initializeHardware(void);
# 13 "initializeHardware.c" 2

# 1 "./device_config.h" 1
# 14 "initializeHardware.c" 2
...
void initializeADC_CLK(void)
{
    ...
    PWM1ERSbits.ERS = 0b00000;


    PWM1CLKbits.CLK = 0b00011;


    PWM1LDSbits.LDS = 0b00000;
    ...
    PWM1GIEbits.S1P2IE = 0;
    PWM1GIEbits.S1P1IE = 0;


    PWM1CONbits.EN = 0;
    PWM1CONbits.LD = 0;
    PWM1CONbits.ERSPOL = 0;
    PWM1CONbits.ERSNOW = 0;
    ...
    PWM1S1P1Hbits.S1P1H = 0x00;
    PWM1S1P1Lbits.S1P1L = 0x40;




    PWM1S1P2Hbits.S1P2H = 0x00;
    PWM1S1P2Lbits.S1P2L = 0x40;



    PWMLOADbits.MPWM1LD = 0;
