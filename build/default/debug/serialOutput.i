...
volatile _Bool senderBusy = 0;
# 44 "serialOutput.c"
void __attribute__((picinterrupt(("low_priority,irq(U1TX),base(8)")))) serialOutput_ISR()
{
...
# 123 "serialOutput.c"
_Bool sendString(char *message)
{
 if(senderBusy) return 0;
 else
 {
